...
import type { GetUmbracoExaminepeekApiV1PingData, GetUmbracoExaminepeekApiV1PingErrors, GetUmbracoExaminepeekApiV1PingResponses, GetUmbracoExaminepeekApiV1RecordByKeyData, GetUmbracoExaminepeekApiV1RecordByKeyErrors, GetUmbracoExaminepeekApiV1RecordByKeyResponses } from './types.gen';
...
export class ExaminePeekService {
    ...
    public static getUmbracoExaminepeekApiV1Ping<ThrowOnError extends boolean = false>(options?: Options<GetUmbracoExaminepeekApiV1PingData, ThrowOnError>) {
        return (options?.client ?? client).get<GetUmbracoExaminepeekApiV1PingResponses, GetUmbracoExaminepeekApiV1PingErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
    ...
    public static getUmbracoExaminepeekApiV1RecordByKey<ThrowOnError extends boolean = false>(options: Options<GetUmbracoExaminepeekApiV1RecordByKeyData, ThrowOnError>) {
        return (options.client ?? client).get<GetUmbracoExaminepeekApiV1RecordByKeyResponses, GetUmbracoExaminepeekApiV1RecordByKeyErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
